...
--
-- Host: localhost    Database: ceramic_store_db
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'Ceramica artesanal',_binary '','Animales','',''),(2,'Frutas',_binary '','Frutas','',''),(3,'Piezas',_binary '','Piezas','','');
...
INSERT INTO `personas` VALUES (1,'25/11/2003','73332055','JOSE ANTHONY','ADANAQUE','ZUÑIGA','JOSE ANTHONY ADANAQUE ZUÑIGA');
...
INSERT INTO `products` VALUES (1,'/categorias/loro.png','Loro',85.50,_binary '',12,1),(2,'/categorias/delfin.png','Delfin Rosado',25.00,_binary '',12,1),(3,'/categorias/brujas.png','Brujas',150.00,_binary '\0',15,1),(4,'/categorias/buho.png','Buho',80.50,_binary '',20,1),(5,'/categorias/perro.png','Perro',150.00,_binary '',30,1),(6,'/categorias/jarrones.png','Jarrones',75.00,_binary '',27,3),(7,'/categorias/frutas.png','Frutas',100.00,_binary '',15,2),(8,'/categorias/brujas.png','Brujas',270.00,_binary '',50,3),(9,'/categorias/set_frutal.png','Set Frutal',150.00,_binary '',30,2);
...
INSERT INTO `users` VALUES (1,'AireSeco@hotmail.com','$2a$10$CsDnr36SMX.LzN2ZR832g.WHqxyUjFjG6icCB0MMNSn7FSv98LG.a',1,2,'LOCAL',NULL);
...
-- Dump completed on 2026-06-08 19:09:04
