...
public class AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        String personaName = user.getPersona() != null ? user.getPersona().getName() : "Administrador";
        return new LoginResponse(token, personaName, user.getRole().getName());
    }
    ...
    public LoginResponse loginWithGoogle(GoogleLoginRequest request) {
        ...
        String token = jwtService.generateToken(userDetails);
        String personaName = user.getPersona() != null ? user.getPersona().getName() : "Usuario";
        return new LoginResponse(token, personaName, user.getRole().getName());
    }
