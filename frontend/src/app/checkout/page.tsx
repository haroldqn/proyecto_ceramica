        ...
        <section className="bg-white rounded-2xl shadow-md p-8 border border-slate-200">
          ...
          <form className="space-y-4">
            ...
            <div className="flex justify-end mt-6">
              <button type="submit" className="bg-[#F04D30] hover:bg-[#d33c23] text-white font-semibold py-2 px-6 rounded-md transition-colors shadow-md">
                Continuar
              </button>
            </div>
          </form>
        ...
        <section className="bg-white rounded-2xl shadow-md p-8 border border-slate-200 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <FaCcVisa className="text-2xl text-[#F04D30]" />
              <span className="font-medium">Visa</span>
            </div>
            <div className="flex items-center space-x-2">
              <FaCcMastercard className="text-2xl text-[#F04D30]" />
              <span className="font-medium">Mastercard</span>
            </div>
            <div className="flex items-center space-x-2">
              <FaMoneyBillWave className="text-2xl text-[#F04D30]" />
              <span className="font-medium">PagoEfectivo</span>
            </div>
            <div className="flex items-center space-x-2">
              <FaUniversity className="text-2xl text-[#F04D30]" />
              <span className="font-medium">BBVA / BCP</span>
            </div>
            <div className="flex items-center space-x-2">
              <FaMobileAlt className="text-2xl text-[#F04D30]" />
